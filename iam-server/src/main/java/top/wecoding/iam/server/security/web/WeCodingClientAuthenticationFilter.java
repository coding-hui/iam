 ...
 * @since 0.5
 */
public class WeCodingClientAuthenticationFilter extends OncePerRequestFilter {
  ...
  /**
   * Constructs an {@code WeCodingClientAuthenticationFilter} using the provided parameters.
   *
   ...
   *     HttpServletRequest}
   */
  public WeCodingClientAuthenticationFilter(
