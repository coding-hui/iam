...
public class OAuth2EndpointUtils {
  ...
  public final String ACCESS_TOKEN_REQUEST_ERROR_URI =
   ...
   * @param claims 扩展信息
   */
  public OAuth2AccessTokenResponse sendAccessTokenResponse(
      OAuth2Authorization authentication, Map<String, Object> claims) {
