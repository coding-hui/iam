...
type RedisOptions struct {
	...
	MaxIdle               int      `json:"optimisationMaxIdle"   mapstructure:"optimisationMaxIdle"`
	MaxActive             int      `json:"optimisationMaxActive" mapstructure:"optimisationMaxActive"`
	Timeout               int      `json:"timeout"               mapstructure:"timeout"`
	EnableCluster         bool     `json:"enableCluster"         mapstructure:"enableCluster"`
	UseSSL                bool     `json:"useSSL"                mapstructure:"useSSL"`
	SSLInsecureSkipVerify bool     `json:"sslInsecureSkipVerify" mapstructure:"sslInsecureSkipVerify"`
}
