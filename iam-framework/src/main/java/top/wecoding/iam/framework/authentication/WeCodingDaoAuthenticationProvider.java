package top.wecoding.iam.framework.authentication;
 ...
 */
@Service
public class WeCodingDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
  ...
  public WeCodingDaoAuthenticationProvider() {
