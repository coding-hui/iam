...
This can improve your R&D efficiency.`)
	...
	cmdTemplate = `// Copyright (c) 2023 coding-hui. All rights reserved.
// Use of this source code is governed by a MIT style
// license that can be found in the LICENSE file.
...
to quickly create a Cobra application.{{.Dot}})
	...
	{{.CommandName}}Example = templates.Examples({{.Dot}}
		...
		iamctl {{.CommandName}} coding-hui coding-huipass{{.Dot}})
...
`
	...
	maincmdTemplate = `// Copyright (c) 2023 coding-hui. All rights reserved.
// Use of this source code is governed by a MIT style
// license that can be found in the LICENSE file.
...
`
	subcmd1Template = `// Copyright (c) 2023 coding-hui. All rights reserved.
// Use of this source code is governed by a MIT style
// license that can be found in the LICENSE file.
...
to quickly create a Cobra application.{{.Dot}})
	...
	subcmd1Example = templates.Examples({{.Dot}}
		...
		iamctl {{.CommandName}} subcmd1 coding-hui coding-huipass

		# Print all option values for subcmd1 with --persistent specified
		iamctl {{.CommandName}} subcmd1 coding-hui coding-huipass --persistent="specified persistent option in command line"{{.Dot}})
...
`
	subcmd2Template = `// Copyright (c) 2023 coding-hui. All rights reserved.
// Use of this source code is governed by a MIT style
// license that can be found in the LICENSE file.
