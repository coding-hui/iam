...
import top.wecoding.iam.framework.IgnoreWhiteProperties;
 ...
 * @qq 1515418211
 */
public class IAMBearerTokenExtractor implements BearerTokenResolver {
  ...
  public IAMBearerTokenExtractor(IgnoreWhiteProperties urlProperties) {
